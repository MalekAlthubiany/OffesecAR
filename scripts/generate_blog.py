...
def create_blog_image(title: str, category: str, slug: str) -> Path:
    ...
    draw.text((154, 61), category, font=font_cat, fill=cat_color, anchor="mm")
    ...
    title_lines = wrap_text(title, font_title, W - 120)
    y = 130
    ...
    draw.text((60, H - 44), "OffsecAR", font=font_brand, fill="#444444")
